      ...
      widget: (
        <div className="glass-card p-8 rounded-xl relative overflow-hidden group">
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="border-2 border-dashed border-billsync-accent/30 rounded-lg p-8 text-center relative z-10"
      ...
      widget: (
        <div className="glass-card p-8 rounded-xl">
          <motion.div className="space-y-4">
            {[
              { label: "Product Names", confidence: 98 },
              { label: "Categories", confidence: 96 },
              { label: "Gross Amount", confidence: 99 },
              { label: "Tax Data", confidence: 97 },
              { label: "State", confidence: 100 },
              { label: "Date", confidence: 99 },
            ].map((item, index) => (
              <motion.div
                key={index}
      ...
      widget: (
        <div className="glass-card p-8 rounded-xl">
          <div className="space-y-6">
            ...
            >
              {[
                { label: "Total Receipts", value: "1,234" },
