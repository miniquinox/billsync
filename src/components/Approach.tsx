...
const Approach = () => {
  ...
  const workflow = [{
    ...
    widget: (
      ...
      >
        <motion.div 
          className="absolute -top-20 -right-20 w-40 h-40 bg-[#9b87f5]/10 rounded-full blur-3xl"
          animate={{
        ...
        />
        <motion.div 
          className="absolute -bottom-20 -left-20 w-40 h-40 bg-[#9b87f5]/10 rounded-full blur-3xl"
          animate={{
            scale: isUploading ? 1.2 : 1,
            opacity: isUploading ? 0.3 : 0.1,
          }}
        ...
        >
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="border-2 border-dashed border-[#9b87f5]/30 rounded-lg p-6 text-center relative z-10 cursor-pointer"
    ...
    widget: (
      ...
      >
        <motion.div 
          className="absolute -top-20 -right-20 w-40 h-40 bg-[#1EAEDB]/10 rounded-full blur-3xl"
          animate={{
            scale: [1, 1.2, 1],
            opacity: [0.1, 0.3, 0.1],
          }}
        ...
        />
        <motion.div 
          className="absolute -bottom-20 -left-20 w-40 h-40 bg-[#1EAEDB]/10 rounded-full blur-3xl"
          animate={{
            scale: [1.2, 1, 1.2],
            opacity: [0.1, 0.3, 0.1],
          }}
    ...
    widget: (
      ...
      >
        <motion.div 
          className="absolute -top-20 -right-20 w-40 h-40 bg-[#D946EF]/10 rounded-full blur-3xl"
          animate={{
            scale: [1, 1.2, 1],
            opacity: [0.1, 0.3, 0.1],
          }}
        ...
        />
        <motion.div 
          className="absolute -bottom-20 -left-20 w-40 h-40 bg-[#D946EF]/10 rounded-full blur-3xl"
          animate={{
            scale: [1.2, 1, 1.2],
            opacity: [0.1, 0.3, 0.1],
          }}
        ...
        >
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-3">
                <motion.div
                  className="p-2.5 rounded-lg bg-white/5 text-[#D946EF]"
                  animate={{
                    rotate: [0, 10, -10, 0]
                  }}
                  transition={{
                ...
                {[{
                  ...
                  >
                    ...
                    <div className="w-full bg-white/5 rounded-full h-1">
                      <motion.div
                        className="bg-[#D946EF] h-1 rounded-full"
                        initial={{ width: 0 }}
